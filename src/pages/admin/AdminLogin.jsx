  ...
  return (
    <main className="h-screen w-screen overflow-hidden flex flex-col md:flex-row bg-background">
        ...
        <div className="max-w-[420px] w-full flex flex-col justify-center py-8">
          ...
          <div className="text-center mb-6">
            ...
            <p className="font-body-md text-sm text-secondary">
              Secure access to the NexaCart enterprise command center.
            </p>
          </div>
          ...
          <p className="mt-6 text-center font-body-md text-secondary">Don't have an account? <span onClick={() => navigate("/admin/signup")} className="text-primary font-semibold hover:underline cursor-pointer">Sign up here</span></p>
        </div>
      </section>
      ...
      <section className="hidden md:block w-1/2 h-full relative overflow-hidden bg-primary-container">
        ...
        {/* Branding Accent Box */}
        <div className="absolute bottom-12 left-12 right-12 glass-effect p-8 rounded-xl z-10 text-left">
          <div className="flex items-center gap-2 mb-3">
            <span className="material-symbols-outlined text-primary">security</span>
            <span className="font-label-sm text-label-sm text-primary uppercase tracking-widest font-bold">Admin Console</span>
          </div>
          <blockquote className="font-display-md text-xl text-primary font-semibold leading-relaxed">
            "Security is not a product, but a process."
          </blockquote>
          <p className="font-body-md text-sm text-secondary mt-2">– Bruce Schneier</p>
        </div>
      </section>
    </main>
  );
