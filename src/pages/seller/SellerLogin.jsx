        ...
        <div className="max-w-[420px] w-full flex flex-col justify-center py-8">
          ...
          <div className="text-center mb-6">
            ...
            <p className="font-body-md text-sm text-secondary">
              Access your merchant dashboard to manage your global sales.
            </p>
          </div>
          ...
          <p className="mt-6 text-center font-body-md text-secondary">Don't have an account? <span onClick={() => navigate("/seller/signup")} className="text-primary font-semibold hover:underline cursor-pointer">Sign up here</span></p>
        </div>
      </section>
